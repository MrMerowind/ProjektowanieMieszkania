...
namespace ProjektowanieMieszkaniaCSharp
{
    class Door
    {
        ...
        public Door(PointF _start, PointF _end, float _thickness)
        {
            start = _start;
            end = _end;
        ...
        public Door(float _startX, float _startY, float _endX, float _endY, float _thickness)
        {
            start.X = _startX;
            start.Y = _startY;
        ...
        public Door(float _startX, float _startY, float _endX, float _endY, float _thickness, Color c)
        {
            start.X = _startX;
            start.Y = _startY;
        ...
        public void setStart(float positionX, float positionY)
        {
            start.X = positionX;
            start.Y = positionY;
        }

        public void setEnd(float positionX, float positionY)
        {
            end.X = positionX;
            end.Y = positionY;
        }
        ...
        public PointF getPositionWithThickness()
        {
            ...
            {
                throw new System.InvalidOperationException("Drzwi nie są ani poziome ani pionowe getPositionWithThickness()");
            }
        }
        public PointF getSizeWithThickness()
        {
            ...
            {
                throw new System.InvalidOperationException("Drzwi nie są ani poziome ani pionowe getSizeWithThickness()");
            }
        }
